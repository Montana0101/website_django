    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2021, 2, 14, 20, 9, 3, 918715), verbose_name='添加时间')),
                ('name', models.CharField(max_length=300, verbose_name='章节名称')),
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(default=datetime.datetime(2021, 2, 14, 20, 9, 3, 918715), verbose_name='添加时间')),
                ('name', models.CharField(max_length=300, verbose_name='视频名称')),
                ('learn_times', models.IntegerField(default=0, verbose_name='学习时长')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=200, upload_to='course/resourse/%Y/%m', verbose_name='封面图')),
